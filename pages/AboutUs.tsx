...
const AboutUs = () => {
  return (
    <div className="relative flex min-h-screen flex-col bg-background-dark font-sans text-white antialiased overflow-x-hidden selection:bg-primary selection:text-background-dark">
        {/* Header */}
        <header className="sticky top-0 z-50 flex items-center justify-between border-b border-border-dark bg-background-dark/95 backdrop-blur-md px-10 py-3">
            ...
            <div className="flex flex-1 justify-end gap-8">
                <nav className="hidden md:flex items-center gap-9">
                    <button className="text-white text-sm font-medium hover:text-primary transition-colors bg-transparent border-none cursor-pointer" onClick={() => window.location.hash = '#/'}>Home</button>
                    <button className="text-white text-sm font-medium hover:text-primary transition-colors bg-transparent border-none cursor-pointer" onClick={() => window.location.hash = '#/search'}>Services</button>
                    <button className="text-white text-sm font-medium hover:text-primary transition-colors bg-transparent border-none cursor-pointer" onClick={() => window.location.hash = '#/dashboard'}>Track</button>
                    <button className="text-primary text-sm font-bold bg-transparent border-none cursor-pointer" onClick={() => window.location.hash = '#/about'}>About Us</button>
                    <button className="text-white text-sm font-medium hover:text-primary transition-colors bg-transparent border-none cursor-pointer" onClick={() => window.location.hash = '#/contact'}>Contact</button>
                </nav>
                <button 
                    onClick={() => window.location.hash = '#/login'}
                    className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-background-dark text-sm font-bold hover:bg-primary-hover transition-colors"
                >
        ...
        <main className="flex-grow flex flex-col items-center">
                    ...
                    <div className="relative z-10 flex min-h-[480px] flex-col items-center justify-center gap-6 p-8 text-center">
                        <div className="flex flex-col gap-4 max-w-3xl">
                            <h1 className="text-white text-5xl font-black leading-tight tracking-[-0.033em] md:text-7xl">
                                Rewiring the <span className="text-primary">Future</span>
                            </h1>
                        ...
                        <div className="flex gap-4 pt-4">
                            <button onClick={() => window.location.hash = '#/search'} className="flex h-12 items-center justify-center rounded-lg bg-primary px-8 text-background-dark text-base font-bold transition-transform hover:scale-105">
                                Join the Movement
                            </button>
                            <button className="flex h-12 items-center justify-center rounded-lg border border-border-dark bg-background-card/50 px-8 text-white text-base font-bold backdrop-blur-sm transition-colors hover:bg-background-card hover:border-primary">
                                Watch Video
                            </button>
                        </div>
                    </div>
            ...
            <section className="w-full max-w-7xl px-4 py-10 md:px-10">
                <div className="grid grid-cols-2 gap-6 md:grid-cols-4 border-y border-border-dark py-12">
                    <div className="flex flex-col items-center justify-center gap-2 text-center">
                        <span className="text-4xl font-black text-primary md:text-5xl">50K+</span>
                        <span className="text-sm font-medium text-text-secondary uppercase tracking-wider">Devices Recycled</span>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-2 text-center">
                        <span className="text-4xl font-black text-primary md:text-5xl">120</span>
                        <span className="text-sm font-medium text-text-secondary uppercase tracking-wider">Partner Agencies</span>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-2 text-center">
                        <span className="text-4xl font-black text-primary md:text-5xl">800T</span>
                        <span className="text-sm font-medium text-text-secondary uppercase tracking-wider">CO2 Emissions Saved</span>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-2 text-center">
                        <span className="text-4xl font-black text-primary md:text-5xl">15+</span>
                        <span className="text-sm font-medium text-text-secondary uppercase tracking-wider">Countries Reached</span>
                    </div>
                </div>
            </section>
                ...
                <div className="flex flex-col gap-12 lg:flex-row">
                    <div className="flex flex-1 flex-col justify-center gap-6">
                        ...
                        <div className="flex flex-col gap-4 mt-4">
                            <div className="group flex gap-4 rounded-xl border border-border-dark bg-background-card p-6 transition-colors hover:border-primary/50">
                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-primary/20 text-primary group-hover:bg-primary group-hover:text-background-dark transition-colors">
                    ...
                    <div className="flex-1 relative h-[500px] w-full rounded-2xl overflow-hidden group">
                        ...
                        <div className="absolute bottom-8 left-8 right-8">
                            <div className="inline-flex items-center gap-2 rounded-full bg-primary/20 px-3 py-1 text-xs font-bold text-primary backdrop-blur-sm mb-3">
            ...
            {/* Problem vs Solution */}
            <section className="w-full max-w-7xl px-4 py-12 md:px-10">
                <div className="rounded-2xl bg-background-card p-8 md:p-12 border border-border-dark">
                    <div className="flex flex-col gap-10 lg:flex-row items-center">
                        <div className="w-full lg:w-1/2 flex flex-col gap-6">
                            ...
                            <button 
                                ...
                                className="mt-4 w-fit flex items-center gap-2 text-primary font-bold hover:text-white transition-colors bg-transparent border-none cursor-pointer"
                            >
                        ...
                        <div className="w-full lg:w-1/2">
                            <div 
                                className="aspect-video w-full rounded-xl bg-cover bg-center shadow-2xl shadow-primary/10 border border-border-dark" 
            ...
            <section className="w-full max-w-7xl px-4 py-16 md:px-10">
                <div className="text-center mb-12">
                    ...
                    <p className="text-text-secondary mt-4">The principles that drive our innovation</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="flex flex-col items-center text-center p-6 rounded-xl bg-background-card border border-border-dark hover:border-primary transition-all hover:-translate-y-1">
                        <div className="mb-4 p-4 rounded-full bg-background-dark text-primary">
                            <span className="material-symbols-outlined text-4xl">verified_user</span>
                        </div>
                        <h3 className="text-xl font-bold text-white mb-2">Transparency</h3>
                        <p className="text-text-secondary">Real-time tracking of your e-waste from pickup to final processing.</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-6 rounded-xl bg-background-card border border-border-dark hover:border-primary transition-all hover:-translate-y-1">
                        <div className="mb-4 p-4 rounded-full bg-background-dark text-primary">
                        ...
                        <p className="text-text-secondary">Leveraging AI and blockchain to modernize the recycling supply chain.</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-6 rounded-xl bg-background-card border border-border-dark hover:border-primary transition-all hover:-translate-y-1">
                        <div className="mb-4 p-4 rounded-full bg-background-dark text-primary">
                        ...
                        <p className="text-text-secondary">Quantifiable environmental metrics for every device recycled.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="w-full max-w-7xl px-4 py-12 md:px-10">
                <div className="flex flex-col gap-10 md:flex-row md:gap-20">
                    <div className="md:w-1/3">
                        ...
                        <p className="sticky top-36 mt-4 text-text-secondary">From a garage project to a global movement, here is how EcoCycle has evolved over the years.</p>
                    </div>
                    <div className="md:w-2/3">
                        ...
                        <div className="grid grid-cols-[40px_1fr] gap-x-4">
                            ...
                            <div className="flex flex-col items-center gap-1 pt-2">
                                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-background-card border border-border-dark text-primary z-10">
                                    <span className="material-symbols-outlined text-xl">rocket_launch</span>
                                </div>
                                <div className="w-[2px] bg-gradient-to-b from-border-dark to-border-dark h-24 grow"></div>
                            </div>
                            <div className="flex flex-col pb-12 pt-2">
                                <span className="text-primary text-sm font-bold">2021</span>
                                <h3 className="text-white text-xl font-bold mt-1">Founded in a Garage</h3>
                                <p className="text-text-secondary mt-2">Started with a small team of 3 engineers passionate about reducing local electronic waste.</p>
                            </div>
                            {/* Item 2 */}
                            <div className="flex flex-col items-center gap-1">
                                <div className="w-[2px] bg-border-dark h-4"></div>
                                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-background-card border border-border-dark text-primary z-10">
                                    <span className="material-symbols-outlined text-xl">trophy</span>
                                </div>
                                <div className="w-[2px] bg-border-dark h-24 grow"></div>
                            </div>
                            <div className="flex flex-col pb-12">
                                ...
                                <p className="text-text-secondary mt-2">Reached a major milestone of processing 10k devices and partnered with 5 major recycling plants.</p>
                            </div>
                            {/* Item 3 */}
                            <div className="flex flex-col items-center gap-1">
                                <div className="w-[2px] bg-border-dark h-4"></div>
                            ...
                            <div className="flex flex-col pb-12">
                                ...
                                <p className="text-text-secondary mt-2">Expanded operations to 50 major cities and introduced the corporate recycling program.</p>
                            </div>
                            {/* Item 4 */}
                            <div className="flex flex-col items-center gap-1">
                                <div className="w-[2px] bg-border-dark h-4"></div>
                            ...
                            <div className="flex flex-col pb-4">
                                ...
                                <p className="text-text-secondary mt-2">Launched international pilot programs and integrated blockchain tracking for complete transparency.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="w-full max-w-7xl px-4 py-16 md:px-10">
                <div className="flex flex-col gap-4 mb-10">
                    ...
                    <p className="text-text-secondary max-w-2xl">The diverse team of environmentalists, engineers, and strategists working behind the scenes.</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="group relative overflow-hidden rounded-xl bg-background-card">
                        ...
                        <div className="absolute bottom-0 p-4 w-full">
                            ...
                            <p className="text-primary text-sm font-medium">Chief Technology Officer</p>
                        </div>
                    </div>
                    {/* Member 3 */}
                    <div className="group relative overflow-hidden rounded-xl bg-background-card">
                    ...
                    <div className="group relative overflow-hidden rounded-xl bg-background-card">
                        ...
                        <div className="absolute bottom-0 p-4 w-full">
                            ...
                            <p className="text-primary text-sm font-medium">Sustainability Lead</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="w-full px-4 py-20">
                <div className="mx-auto max-w-5xl overflow-hidden rounded-3xl bg-primary relative">
                    ...
                    <div className="relative flex flex-col items-center gap-6 px-4 py-16 text-center md:px-20">
                        <h2 className="text-3xl font-black text-background-dark md:text-5xl max-w-2xl">
                            Ready to make a difference?
                        </h2>
                        <p className="max-w-xl text-lg font-medium text-background-dark/80">
                            Join thousands of eco-conscious individuals and businesses. Schedule your first pickup today.
                        </p>
                        <div className="flex flex-col gap-3 sm:flex-row">
                            <button 
                                onClick={() => window.location.hash = '#/search'}
                                className="flex h-12 min-w-[160px] cursor-pointer items-center justify-center rounded-lg bg-background-dark px-6 text-white text-base font-bold transition-transform hover:scale-105"
                            >
                                Book Pickup
                            </button>
                            <button 
                                onClick={() => window.location.hash = '#/contact'}
                                className="flex h-12 min-w-[160px] cursor-pointer items-center justify-center rounded-lg border-2 border-background-dark px-6 text-background-dark text-base font-bold transition-colors hover:bg-background-dark/10"
                            >
                                Contact Sales
                            </button>
                        </div>
        ...
        {/* Footer */}
        <footer className="border-t border-border-dark bg-background-dark px-10 py-12">
            <div className="mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:justify-between">
                ...
                <div className="grid grid-cols-2 gap-10 sm:grid-cols-3">
                    <div className="flex flex-col gap-4">
                        ...
                        <button onClick={() => window.location.hash = '#/about'} className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">About</button>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Careers</button>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Press</button>
                    </div>
                    <div className="flex flex-col gap-4">
                        <h3 className="text-sm font-bold text-white uppercase tracking-wider">Resources</h3>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Blog</button>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Help Center</button>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Guidelines</button>
                    </div>
                    <div className="flex flex-col gap-4">
                        <h3 className="text-sm font-bold text-white uppercase tracking-wider">Legal</h3>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Privacy</button>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Terms</button>
                        <button className="text-sm text-text-secondary hover:text-primary text-left bg-transparent border-none cursor-pointer">Security</button>
                    </div>
                </div>
            </div>
            <div className="mx-auto mt-12 max-w-7xl border-t border-border-dark pt-8 text-center text-sm text-text-secondary">
